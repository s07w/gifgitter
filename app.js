var tags = ["dog", "coltrane", "bass", "office"];
...
$(document).on("click", ".tag-buttons", function(event) {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + window.encodeURI(type) + "&limit=15&api_key=dc6zaTOxFJmzC";
...
$("body").on('click', '.gif', function() {
    ...
    if($(this).hasClass('playing')) {
        ...
        $(this).attr('src', src.replace(/\_.sgif/i, ".gif"))
    }
});
